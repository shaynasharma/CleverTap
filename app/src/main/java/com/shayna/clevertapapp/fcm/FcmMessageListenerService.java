package com.shayna.clevertapapp.fcm;
...
public class FcmMessageListenerService extends FirebaseMessagingService {
	...
	public void onNewToken(@NonNull String s) {
		...
		CleverTapAPI.createNotificationChannel(this,"CleverTap786","CleverTap786","Channel for Push in App", NotificationManager.IMPORTANCE_HIGH,true);
	}
